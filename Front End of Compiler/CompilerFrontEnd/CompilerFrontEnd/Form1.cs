    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int itr = 0; itr < charinput.Length; itr++)
            {
                ...
                Match_Operator.Success || Match_Special.Success || charinput[itr].Equals(' '))
                {
            ...
            for (int i = 0; i < finalArray.Count; i++)
            {
                ...
                for (int x = 0; x < finalArrayc.Count; x++)
                {
                    ...
                    {
                        // if a current lexeme is an operator then make a tokene.g. < op, = >
                    ...
                    else if (variables.Success)
                    {
                        ...
                        if (!keywordList.Contains(finalArrayc[x].ToString())) // if it is not a keyword
                        {
                            ...
                            //Category2- Variable initialization of type  e.g.String var = ' Hello ';
                            ...
                            //if it is a category 2 then add a row in symbol tablecontaining the information related to that variable
                            ...
                            {
                                // if any other category line comes in we check if
                                //we have initializes that varaible before,
                                // if we have initiazed it before then we put the
                                //index of that variable in symbol table, in its token
                                String ind = "Default";
                                String ty = "Default";
                                String val = "Default";
                                String lin = "Default";
        ...
        private void tfTokens_TextChanged(object sender, EventArgs e)
        {
